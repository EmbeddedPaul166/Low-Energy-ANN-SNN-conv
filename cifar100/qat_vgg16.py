...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-path', type=str, default='cifar100/quant-relu-vgg16', required=False)
    parser.add_argument('--input-path', type=str, default='cifar100/base-relu-vgg16', required=False)
