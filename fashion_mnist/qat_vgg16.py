...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-path', type=str, default='fashion_mnist/quant-relu-vgg16', required=False)
    parser.add_argument('--input-path', type=str, default='fashion_mnist/base-relu-vgg16', required=False)
    ...
    parser.add_argument('--learning-rate', type=float, default=0.000001, required=False)
