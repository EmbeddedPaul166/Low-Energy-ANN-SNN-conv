...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-path', type=str, default='mnist/quant-relu-lenet5', required=False)
    parser.add_argument('--input-path', type=str, default='mnist/base-relu-lenet5', required=False)
